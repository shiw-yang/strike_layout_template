...
const (
	...
	UnknownCode = 500
	// TimeOutCode is unknown code for time out
	TimeOutCode = 408
	// UnknownReason is unknown why error info.
	UnknownReason = ""
	// TimeOutReason is timeout why error
	TimeOutReason = ""
...
var (
	TimeOutError = New(TimeOutCode, TimeOutReason, "")
)
