...
type Server_HTTP struct {
	...
	Timeout *durationpb.Duration `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty" mapstructure:"timeout"`
}
...
type Server_GRPC struct {
	...
	Port string `protobuf:"bytes,2,opt,name=port,proto3" json:"port,omitempty" mapstructure:"port"`
	// @inject_tag: mapstructure:"timeout"
	Timeout *durationpb.Duration `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty" mapstructure:"timeout"`
}
...
func (x *Server_GRPC) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0a, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x1a, 0x1e, 0x67,
	...
	0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x74, 0x72,
	0x69, 0x6b, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x06,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x61, 0x70,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x61,
	...
	0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e,
	...
	0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x2b, 0x5a, 0x29, 0x73, 0x74, 0x72, 0x69, 0x6b,
	0x65, 0x5f, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
...
var file_conf_conf_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),           // 0: strike.api.Bootstrap
	(*Server)(nil),              // 1: strike.api.Server
	(*Data)(nil),                // 2: strike.api.Data
	(*Server_HTTP)(nil),         // 3: strike.api.Server.HTTP
	(*Server_GRPC)(nil),         // 4: strike.api.Server.GRPC
	(*Data_Database)(nil),       // 5: strike.api.Data.Database
	(*Data_Redis)(nil),          // 6: strike.api.Data.Redis
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: strike.api.Bootstrap.server:type_name -> strike.api.Server
	2,  // 1: strike.api.Bootstrap.data:type_name -> strike.api.Data
	3,  // 2: strike.api.Server.http:type_name -> strike.api.Server.HTTP
	4,  // 3: strike.api.Server.grpc:type_name -> strike.api.Server.GRPC
	5,  // 4: strike.api.Data.database:type_name -> strike.api.Data.Database
	6,  // 5: strike.api.Data.redis:type_name -> strike.api.Data.Redis
	7,  // 6: strike.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: strike.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: strike.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: strike.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
